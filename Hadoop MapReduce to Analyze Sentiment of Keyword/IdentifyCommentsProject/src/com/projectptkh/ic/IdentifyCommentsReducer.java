...
public class IdentifyCommentsReducer
	...
	public void cleanup(Context context) throws IOException, InterruptedException{
		...
		if (overall > 0){
		  ...
		  FileWriter myWriter3 = new FileWriter("/home/ptkh/Downloads/output.txt", true);
  ...
  public void reduce(Text key, Iterable<IntWritable> values, Context context)
	  ...
	  row_id ++;
	  try {
		  File kw = new File ("/home/ptkh/Downloads/keyword.txt");		// Getting the keyword from the file
	  ...
	  if (str.contains(keyword)) {			// Checking if the comment contains that keyword
		...
		try {
			  File pos = new File ("/home/ptkh/Downloads/positive.txt");		// Checking the positive file
		...
		try {
			  File neg = new File ("/home/ptkh/Downloads/negative.txt");		// Checking the negative file
    	...
    	FileWriter myWriter = new FileWriter("/home/ptkh/Downloads/output.txt", true);		// Creating a resultant file
    	myWriter.write("Comment = " + str + "\n");		// Writing the comment in the file
    	myWriter.close();
    	key.set("Comment = " + str + "\nOverall = ");
		context.write(key, new IntWritable(overall));
    	if (positive > negative){
    		String str1 = "Comment Sentiment = The comment is POSITIVE as number of positive words are = "+ positive;
    		FileWriter myWriter1 = new FileWriter("/home/ptkh/Downloads/output.txt", true);
